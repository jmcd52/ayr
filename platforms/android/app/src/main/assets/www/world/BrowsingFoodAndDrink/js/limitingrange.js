...
var World = {
    ...
    markerDrawableFood: null,
    markerDrawableCafe: null,
    ...
    loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
        ...
        World.foodMarkerList = [];
		World.cafeMarkerList = [];

        /* Start loading marker assets. */
        World.markerDrawableFood = new AR.ImageResource("assets/food.png", {
            onError: World.onError
        });
        World.markerDrawableCafe = new AR.ImageResource("assets/cafe.png", {
            onError: World.onError
        });
        ...
        for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
            ...
            World.foodMarkerList.push(new Marker(singlePoi));
        }
    ...
    */
    ...
    requestDataFromLocal: function requestDataFromLocalFn(lat, lon) {
        ...
        */
         world.loadPoisFromJsonData(myFoodData);
    },
